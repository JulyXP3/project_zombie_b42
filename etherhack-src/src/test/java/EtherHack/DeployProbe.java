 ...
 *
 * Validates via reflection into EtherLuaLoader private chain (avoids
 * touching game classes that need zombie.core.Core):
 *   1. openResource: classpath 404 then fallback scan of user.dir
 *      EtherHack-*.jar zip entries, read all probe Lua sources.
...
public class DeployProbe {
    public static void main(String[] args) throws Exception {
        Class<?> loader = Class.forName("EtherHack.Ether.EtherLuaLoader");
        ...
        String[] probes = {
            "EtherHack/lua/fixes/ReportSanitizer.lua",
            "EtherHack/lua/fixes/SelfProbe.lua",
            "EtherHack/lua/EtherHackMenu.lua",
            "EtherHack/lua/components/ui/EtherTheme.lua"
        };
        String[] sigs = {
            "EtherMain", "EtherTheme", "EtherKeyBinds", "UIButton", "EtherFormPanel"
        };
