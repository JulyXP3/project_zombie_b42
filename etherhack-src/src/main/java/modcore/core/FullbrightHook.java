...
public final class FullbrightHook {
    ...
    public static int vertLightOverride() {
        if (CoreMain.getInstance() == null) {
            return 0;
        }
        if (CoreMain.getInstance().CoreAPI == null) {
            return 0;
        }
        return CoreMain.getInstance().CoreAPI.isFullbright ? -1 : 0;
    }
    ...
    public static void cacheLightInfoHook(IsoGridSquare square) {
        ...
        if (!CoreMain.getInstance().CoreAPI.isFullbright) {
            return;
        }
