 ...
 * (CoreAPI.loadAPI 挂钩; i18n 全局 getTranslate 由 LuaMethods 提供)。
 *
 * 持久配置: modcore/config/drive.properties (cruiseSpeed), 同 CoreAPI 配置模式。
 *
...
public final class AutoDriveAPI {

    private static File configFile() {
        return new File(modcore.core.CoreAPI.configDir(), "drive.properties");
    }

    private AutoDriveAPI() {
    }
    ...
    // ================================================================
    // 配置持久化 (modcore/config/drive.properties)
    // ================================================================
