...
function UIStatsEditor:createChildren()
    ...
    self.killsEntry = ISTextEntryBox:new(tostring(getZombieKills()), 120, 20, 100, EtherTheme.entryH)
    ...
    self.hoursEntry = ISTextEntryBox:new(tostring(getHoursAlive()), 120, 60, 100, EtherTheme.entryH)
