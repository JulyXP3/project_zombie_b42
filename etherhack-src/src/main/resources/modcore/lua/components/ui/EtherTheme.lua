...
function EtherTheme.getNoise()
    return lazyTex(EtherTheme.singleTex, "noise", "modcore/media/ui/noise.png");
end

function EtherTheme.getCloseTexture()
    return lazyTex(EtherTheme.singleTex, "close", "modcore/media/ui/close_re.png");
end
...
function EtherTheme.getAtlas()
    return lazyTex(EtherTheme.singleTex, "atlas", "modcore/media/ui/chamfer_atlas.png");
end
