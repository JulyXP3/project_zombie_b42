--[[
    ...
    Usage:
        require "modcore/lua/fixes/ServerSyncBlocker"
...
function ServerSyncBlocker.enableFull()
    ...
    print("[modcore] Full server sync protection enabled")
    return true
end
...
function ServerSyncBlocker.disableFull()
    ...
    ServerSyncBlocker.statsProtected = {}
    ServerSyncBlocker.skillsProtected = {}
    print("[modcore] Server sync protection disabled")
    return true
end
...
function ServerSyncBlocker.enableGodModeProtection()
    ...
    print("[modcore] GodMode stats protection enabled")
end
...
function ServerSyncBlocker.enableVehicle()
    ...
    print("[modcore] Vehicle protection enabled - hotwire & engine will be kept locally, server authorization in progress")
    return true
end
...
function ServerSyncBlocker.disableVehicle()
    ...
    ServerSyncBlocker.vehicleConfirming = false
    print("[modcore] Vehicle protection disabled")
    return true
end
...
function ServerSyncBlocker.confirmVehicleProtection()
    ...
    if ok then
        print("[modcore] Vehicle hotwire & engine authorized, protection auto-disabled")
    else
        print("[modcore] Vehicle protection auto-disabled (engine did not start / server did not authorize)")
    end
end
...
function ServerSyncBlocker.updateInstantEngineStart()
    ...
    if vehicle:isEngineRunning() then
        ...
        print("[modcore] Engine started - auto-retry disabled")
        return
    end
    local now = getTimestampMs()
...
print("[modcore] ServerSyncBlocker Lua wrapper loaded")
